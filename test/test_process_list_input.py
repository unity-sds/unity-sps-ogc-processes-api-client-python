...
class TestProcessListInput(unittest.TestCase):
    """ProcessListInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProcessListInput:
        """Test ProcessListInput
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ProcessListInput`
        """
        model = ProcessListInput()
        if include_optional:
