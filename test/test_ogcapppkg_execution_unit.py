...
class TestOgcapppkgExecutionUnit(unittest.TestCase):
    """OgcapppkgExecutionUnit unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OgcapppkgExecutionUnit:
        """Test OgcapppkgExecutionUnit
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `OgcapppkgExecutionUnit`
        """
        model = OgcapppkgExecutionUnit()
        if include_optional:
            return OgcapppkgExecutionUnit(
                type = '',
                image = '',
                deployment = '',
    ...
    def testOgcapppkgExecutionUnit(self):
        """Test OgcapppkgExecutionUnit"""
