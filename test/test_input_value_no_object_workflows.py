...
class TestInputValueNoObjectWorkflows(unittest.TestCase):
    """InputValueNoObjectWorkflows unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InputValueNoObjectWorkflows:
        """Test InputValueNoObjectWorkflows
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `InputValueNoObjectWorkflows`
        """
        model = InputValueNoObjectWorkflows()
        if include_optional:
            return InputValueNoObjectWorkflows(
    ...
    def testInputValueNoObjectWorkflows(self):
        """Test InputValueNoObjectWorkflows"""
