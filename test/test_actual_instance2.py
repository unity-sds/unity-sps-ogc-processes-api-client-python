...
class TestActualInstance2(unittest.TestCase):
    """ActualInstance2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActualInstance2:
        """Test ActualInstance2
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ActualInstance2`
        """
        model = ActualInstance2()
        if include_optional:
            return ActualInstance2(
