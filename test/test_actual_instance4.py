...
class TestActualInstance4(unittest.TestCase):
    """ActualInstance4 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActualInstance4:
        """Test ActualInstance4
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ActualInstance4`
        """
        model = ActualInstance4()
        if include_optional:
            return ActualInstance4(
                ref = '',
                title = '',
                multiple_of = None,
                maximum = None,
