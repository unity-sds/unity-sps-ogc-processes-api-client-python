...
class TestQualifiedInputValueWorkflows(unittest.TestCase):
    """QualifiedInputValueWorkflows unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QualifiedInputValueWorkflows:
        ...
        # uncomment below to create an instance of `QualifiedInputValueWorkflows`
        """
        model = QualifiedInputValueWorkflows()
        if include_optional:
            return QualifiedInputValueWorkflows(
                media_type = '',
                encoding = '',
    ...
    def testQualifiedInputValueWorkflows(self):
        """Test QualifiedInputValueWorkflows"""
