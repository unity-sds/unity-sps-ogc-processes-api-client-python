...
class TestSchemaOneOfOutput(unittest.TestCase):
    """SchemaOneOfOutput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SchemaOneOfOutput:
        """Test SchemaOneOfOutput
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `SchemaOneOfOutput`
        """
        model = SchemaOneOfOutput()
        if include_optional:
            return SchemaOneOfOutput(
                title = '',
                multiple_of = None,
                maximum = None,
    ...
    def testSchemaOneOfOutput(self):
        """Test SchemaOneOfOutput"""
