...
class TestSchemaOneOfAdditionalPropertiesOutput(unittest.TestCase):
    """SchemaOneOfAdditionalPropertiesOutput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SchemaOneOfAdditionalPropertiesOutput:
        """Test SchemaOneOfAdditionalPropertiesOutput
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `SchemaOneOfAdditionalPropertiesOutput`
        """
        model = SchemaOneOfAdditionalPropertiesOutput()
        if include_optional:
            return SchemaOneOfAdditionalPropertiesOutput(
    ...
    def testSchemaOneOfAdditionalPropertiesOutput(self):
        """Test SchemaOneOfAdditionalPropertiesOutput"""
