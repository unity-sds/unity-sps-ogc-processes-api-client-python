...
class TestInputValueWorkflows(unittest.TestCase):
    """InputValueWorkflows unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InputValueWorkflows:
        """Test InputValueWorkflows
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `InputValueWorkflows`
        """
        model = InputValueWorkflows()
        if include_optional:
            return InputValueWorkflows(
    ...
    def testInputValueWorkflows(self):
        """Test InputValueWorkflows"""
