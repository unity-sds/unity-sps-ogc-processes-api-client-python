...
class TestJobListOutput(unittest.TestCase):
    """JobListOutput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> JobListOutput:
        """Test JobListOutput
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `JobListOutput`
        """
        model = JobListOutput()
        if include_optional:
