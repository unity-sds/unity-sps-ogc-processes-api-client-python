...
class TestSchema1Input(unittest.TestCase):
    """Schema1Input unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Schema1Input:
        """Test Schema1Input
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `Schema1Input`
        """
        model = Schema1Input()
        if include_optional:
            return Schema1Input(
