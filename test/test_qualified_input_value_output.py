...
class TestQualifiedInputValueOutput(unittest.TestCase):
    """QualifiedInputValueOutput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QualifiedInputValueOutput:
        """Test QualifiedInputValueOutput
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `QualifiedInputValueOutput`
        """
        model = QualifiedInputValueOutput()
        if include_optional:
            return QualifiedInputValueOutput(
                media_type = '',
                encoding = '',
    ...
    def testQualifiedInputValueOutput(self):
        """Test QualifiedInputValueOutput"""
