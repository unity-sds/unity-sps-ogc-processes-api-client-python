...
class TestActualInstance1(unittest.TestCase):
    """ActualInstance1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActualInstance1:
        """Test ActualInstance1
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ActualInstance1`
        """
        model = ActualInstance1()
        if include_optional:
            return ActualInstance1(
                bbox = [
                    null
                    ],
