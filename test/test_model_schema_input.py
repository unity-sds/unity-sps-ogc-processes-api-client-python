...
class TestModelSchemaInput(unittest.TestCase):
    """ModelSchemaInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ModelSchemaInput:
        """Test ModelSchemaInput
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ModelSchemaInput`
        """
        model = ModelSchemaInput()
        if include_optional:
            return ModelSchemaInput(
                ref = '',
                title = '',
                multiple_of = None,
                maximum = None,
