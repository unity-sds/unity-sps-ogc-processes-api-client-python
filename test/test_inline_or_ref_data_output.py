...
class TestInlineOrRefDataOutput(unittest.TestCase):
    """InlineOrRefDataOutput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InlineOrRefDataOutput:
        """Test InlineOrRefDataOutput
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `InlineOrRefDataOutput`
        """
        model = InlineOrRefDataOutput()
        if include_optional:
            return InlineOrRefDataOutput(
                bbox = [
                    null
                    ],
    ...
    def testInlineOrRefDataOutput(self):
        """Test InlineOrRefDataOutput"""
