...
class TestJobtimeout(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Jobtimeout:
        """Test Jobtimeout
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `Jobtimeout`
        """
        model = Jobtimeout()
        if include_optional:
            return Jobtimeout(
