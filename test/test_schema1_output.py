...
class TestSchema1Output(unittest.TestCase):
    """Schema1Output unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Schema1Output:
        """Test Schema1Output
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `Schema1Output`
        """
        model = Schema1Output()
        if include_optional:
            return Schema1Output(
