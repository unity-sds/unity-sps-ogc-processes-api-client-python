...
class TestModelSchemaOutput(unittest.TestCase):
    """ModelSchemaOutput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ModelSchemaOutput:
        """Test ModelSchemaOutput
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ModelSchemaOutput`
        """
        model = ModelSchemaOutput()
        if include_optional:
            return ModelSchemaOutput(
                ref = '',
                title = '',
                multiple_of = None,
                maximum = None,
    ...
    def testModelSchemaOutput(self):
        """Test ModelSchemaOutput"""
