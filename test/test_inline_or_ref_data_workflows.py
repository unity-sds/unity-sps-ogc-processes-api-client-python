...
class TestInlineOrRefDataWorkflows(unittest.TestCase):
    """InlineOrRefDataWorkflows unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InlineOrRefDataWorkflows:
        """Test InlineOrRefDataWorkflows
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `InlineOrRefDataWorkflows`
        """
        model = InlineOrRefDataWorkflows()
        if include_optional:
            return InlineOrRefDataWorkflows(
    ...
    def testInlineOrRefDataWorkflows(self):
        """Test InlineOrRefDataWorkflows"""
