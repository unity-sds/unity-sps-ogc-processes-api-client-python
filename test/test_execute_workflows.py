...
class TestExecuteWorkflows(unittest.TestCase):
    """ExecuteWorkflows unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExecuteWorkflows:
        """Test ExecuteWorkflows
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ExecuteWorkflows`
        """
        ...
        if include_optional:
            return ExecuteWorkflows(
                ...
                outputs = {
                    'key' : unity_sps_ogc_processes_api_python_client.models.output_workflows.OutputWorkflows(
