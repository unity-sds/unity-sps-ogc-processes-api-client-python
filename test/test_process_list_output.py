...
class TestProcessListOutput(unittest.TestCase):
    """ProcessListOutput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProcessListOutput:
        """Test ProcessListOutput
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ProcessListOutput`
        """
        model = ProcessListOutput()
        if include_optional:
    ...
    def testProcessListOutput(self):
        """Test ProcessListOutput"""
