...
class TestInlineOrRefDataInput(unittest.TestCase):
    """InlineOrRefDataInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InlineOrRefDataInput:
        """Test InlineOrRefDataInput
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `InlineOrRefDataInput`
        """
        model = InlineOrRefDataInput()
        if include_optional:
            return InlineOrRefDataInput(
                bbox = [
                    null
                    ],
    ...
    def testInlineOrRefDataInput(self):
        """Test InlineOrRefDataInput"""
