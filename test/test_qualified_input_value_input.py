...
class TestQualifiedInputValueInput(unittest.TestCase):
    """QualifiedInputValueInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QualifiedInputValueInput:
        """Test QualifiedInputValueInput
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `QualifiedInputValueInput`
        """
        model = QualifiedInputValueInput()
        if include_optional:
            return QualifiedInputValueInput(
                media_type = '',
                encoding = '',
    ...
    def testQualifiedInputValueInput(self):
        """Test QualifiedInputValueInput"""
