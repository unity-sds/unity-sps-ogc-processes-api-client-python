...
class TestInputWorkflows1(unittest.TestCase):
    """InputWorkflows1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InputWorkflows1:
        """Test InputWorkflows1
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `InputWorkflows1`
        """
        model = InputWorkflows1()
        if include_optional:
            return InputWorkflows1(
