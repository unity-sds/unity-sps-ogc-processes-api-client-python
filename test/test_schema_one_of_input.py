...
class TestSchemaOneOfInput(unittest.TestCase):
    """SchemaOneOfInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SchemaOneOfInput:
        """Test SchemaOneOfInput
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `SchemaOneOfInput`
        """
        model = SchemaOneOfInput()
        if include_optional:
            return SchemaOneOfInput(
                title = '',
                multiple_of = None,
                maximum = None,
