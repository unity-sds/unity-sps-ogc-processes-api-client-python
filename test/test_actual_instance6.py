...
class TestActualInstance6(unittest.TestCase):
    """ActualInstance6 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActualInstance6:
        """Test ActualInstance6
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ActualInstance6`
        """
        model = ActualInstance6()
        if include_optional:
            return ActualInstance6(
