...
class Schema1Output(BaseModel):
    ...
    actual_instance: Optional[ActualInstance4] = None
    one_of_schemas: Optional[List[StrictStr]] = None
    oneof_schema_1_validator: Optional[Reference] = None
    oneof_schema_2_validator: Optional[SchemaOneOfOutput] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "actual_instance": (
                    ActualInstance4.from_dict(obj["actual_instance"])
                ...
                "oneof_schema_2_validator": (
                    SchemaOneOfOutput.from_dict(obj["oneof_schema_2_validator"])
