...
EXECUTE200RESPONSEINPUT_ANY_OF_SCHEMAS = [
    "Dict[str, Execute200ResponseInputAnyOfValue]",
    "List[object]",
    "bool",
    "float",
    "int",
...
class Execute200ResponseInput(BaseModel):
    """
    Execute200ResponseInput
    """

    # data type: Dict[str, Execute200ResponseInputAnyOfValue]
    anyof_schema_1_validator: Optional[Dict[str, Execute200ResponseInputAnyOfValue]] = (
        None
    )
    ...
    # data type: int
    anyof_schema_6_validator: Optional[StrictInt] = None
    # data type: object
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = Execute200ResponseInput.model_construct()
        error_messages = []
        # validate data type: Dict[str, Execute200ResponseInputAnyOfValue]
        try:
        ...
        if error_messages:
            # no match
            raise ValueError(
                "No match found when setting the actual_instance in Execute200ResponseInput with anyOf schemas: Dict[str, Execute200ResponseInputAnyOfValue], List[object], bool, float, int, object, str. Details: "
                + ", ".join(error_messages)
            )
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        error_messages = []
        # deserialize data into Dict[str, Execute200ResponseInputAnyOfValue]
        try:
            # validation
        ...
        if error_messages:
            # no match
            raise ValueError(
                "No match found when deserializing the JSON string into Execute200ResponseInput with anyOf schemas: Dict[str, Execute200ResponseInputAnyOfValue], List[object], bool, float, int, object, str. Details: "
                + ", ".join(error_messages)
            )
        else:
            return instance
