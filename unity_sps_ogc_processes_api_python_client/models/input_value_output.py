...
class InputValueOutput(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if (
            self.anyof_schema_1_validator is None
            and "anyof_schema_1_validator" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.anyof_schema_2_validator is None
            and "anyof_schema_2_validator" in self.model_fields_set
        ):
        ...
        _obj = cls.model_validate(
            {
                ...
                "anyof_schema_1_validator": (
                    InputValueNoObjectOutput.from_dict(obj["anyof_schema_1_validator"])
