...
class ProcessOutput(BaseModel):
    ...
    inputs: Optional[List[InputValueOutput]] = None
    outputs: Optional[List[InputValueOutput]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "inputs": [InputValueOutput.from_dict(_item) for _item in obj["inputs"]] if obj.get("inputs") is not None else None,
            "outputs": [InputValueOutput.from_dict(_item) for _item in obj["outputs"]] if obj.get("outputs") is not None else None
        })
        return _obj
