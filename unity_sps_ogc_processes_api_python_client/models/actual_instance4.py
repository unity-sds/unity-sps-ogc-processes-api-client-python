...
class ActualInstance4(BaseModel):
    """
    ActualInstance4
    """
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        ActualInstance4.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError(
                "No match found when setting the actual_instance in ActualInstance4 with anyOf schemas: Reference, SchemaOneOfOutput. Details: "
                + ", ".join(error_messages)
            )
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError(
                "No match found when deserializing the JSON string into ActualInstance4 with anyOf schemas: Reference, SchemaOneOfOutput. Details: "
                + ", ".join(error_messages)
            )
        else:
            return instance
