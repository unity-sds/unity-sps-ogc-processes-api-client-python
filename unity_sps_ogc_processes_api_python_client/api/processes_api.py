...
class ProcessesApi:
    ...
    def execute_processes_process_id_execution_post(
        ...
        execute_workflows: Optional[ExecuteWorkflows] = None,
        ...
        :type prefer: str
        :param execute_workflows:
        :type execute_workflows: ExecuteWorkflows
    ...
    def execute_processes_process_id_execution_post_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[Execute200ResponseInput]:
        """execute a process.
    ...
    def _execute_processes_process_id_execution_post_serialize(
        ...
        if response is not None:
            ...
            _query_params.append(("response", response))
        ...
        if execute_workflows is not None:
            _body_params = execute_workflows
    ...
    def get_process_description_processes_process_id_get(
        ...
        _param = self._get_process_description_processes_process_id_get_serialize(
            process_id=process_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_process_description_processes_process_id_get_with_http_info(
        self,
        process_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_process_description_processes_process_id_get_without_preload_content(
        self,
        process_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _get_process_description_processes_process_id_get_serialize(
        self,
        process_id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def get_processes_processes_get(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._get_processes_processes_get_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index,
    ...
    @validate_call
    def get_processes_processes_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_processes_processes_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_processes_processes_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
