...
class LandingPageApi:
    ...
    def get_landing_page_get(
        ...
        _param = self._get_landing_page_get_serialize(
            f=f,
    ...
    @validate_call
    def get_landing_page_get_with_http_info(
        self,
        f: Annotated[
            Optional[StrictStr],
            Field(
    ...
    @validate_call
    def get_landing_page_get_without_preload_content(
        self,
        f: Annotated[
            Optional[StrictStr],
            Field(
    ...
    def _get_landing_page_get_serialize(
        self,
        f,
        _request_auth,
        _content_type,
